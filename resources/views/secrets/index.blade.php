<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center justify-items-center">
        ...
        <div class="p-8">
            ...
            <article class="overflow-hidden w-96 h-96 rounded-lg border border-gray-100 bg-white shadow-sm">
                <img
                ...
                <div class="text-gray-500">
                    @if (strlen($post['description']) > 50)
                            <p class="mt-2 w-80 line-clamp-3 text-sm/relaxed" style="overflow-x: hidden; height: 20px;">
                                {{ $post['description'] }}
                            </p>
